...
function synerhubTheThread(thNo) {
	if (thNo == null) {
		...
		$.getJSON(
			"https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=oG2aa7BOAnm12tkIUfXkeDFPYYaHbGzi4ZXQrSiE1DwurK6f843fuJs1zuHjqshV9NClgIokeB2VEhQ0I41gXg%3D%3D&pageNo=1&numOfRows=1000&dataType=JSON&base_date=20241116&base_time=0500&nx=68&ny=100"
			,function (data){
				console.log(data);
